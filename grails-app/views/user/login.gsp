...
<body ng-app="mystackoverflow" ng-controller="QuestionController as vm">
        ...
        <section class="row colset-2-its">
            ...
            <div ng-switch="vm.authenticated">
                <div ng-switch-when="true">
                    <div ng-include="'/mystackoverflow/askQuestion.html'"></div>
                </div>
                <div ng-switch-when="false">
                    <div ng-include="'/mystackoverflow/login.html'"></div>
                </div>
            </div>

            <div ng-include="'/mystackoverflow/list.html'"></div>
        </section>
    </div>
    ...
    <asset:javascript src="/mystackoverflow/app.js" />
</body>
</html>
