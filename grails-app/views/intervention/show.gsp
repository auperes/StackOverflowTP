...
<html>
    ...
    <body>
        ...
        <div id="show-intervention" class="content scaffold-show" role="main">
            ...
            <f:display bean="intervention" />
            <g:form resource="${this.intervention}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.intervention}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
